...
export class Form implements OnInit {
  ...
  makes = [
    'Acura', 'Alfa Romeo', 'American General', 'American Motors', 'Aro', 'Aston Martin', 'Audi', 'Automobili Pininfarina', 'Avanti', 'Azure Dynamics', 'Bentley', 'BMW', 'Brightdrop', 'Bugatti', 'Bugatti Rimac', 'Buick', 'Byd', 'Cadillac', 'Chevrolet', 'Chrysler', 'Daewoo', 'Daihatsu', 'Datsun', 'Dodge', 'Eagle', 'Ferrari', 'Fiat', 'Fisker', 'Ford', 'Freightliner', 'Genesis', 'Geo', 'GEM', 'GMC', 'Honda', 'Hummer', 'Hyundai', 'Ineos', 'Infiniti', 'International', 'Isuzu', 'Iveco', 'Jaguar', 'Jeep', 'Karma', 'Kia', 'Laforza', 'Lamborghini', 'Lancia', 'Land Rover', 'Lexus', 'Lincoln', 'Lordstown', 'Lotus', 'Lucid', 'Mahindra', 'Maserati', 'Maybach', 'Mazda', 'Mclaren', 'Mercedes-Benz', 'Mercury', 'Merkur', 'Mini', 'Mitsubishi', 'Nissan', 'Oldsmobile', 'Peugeot', 'Plymouth', 'Polestar', 'Pontiac', 'Porsche', 'Ram', 'Renault', 'Rivian', 'Rolls-Royce', 'Saab', 'Saturn', 'Smart', 'Spartan', 'Sterling', 'Subaru', 'Suzuki', 'Tesla', 'Toyota', 'Triumph', 'Tvr', 'Vinfast', 'Volkswagen', 'Volvo', 'Yugo', 'Zeekr'
  ];
