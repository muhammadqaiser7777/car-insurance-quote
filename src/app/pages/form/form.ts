...
export class Form implements OnInit {
  ...
  models: { [key: string]: string[] } = {
    ...
    'Spartan': [
        'Spartan Fire Trucks', 'Gladiator', 'Metro Star', 'Metro Star XP', 'Metro Star XL'
    ],
    'Sterling': [
    ...
    'Zeekr': [
        '001', '009', '009 MPV', '001 GT', 'Zeekr X'
    ]
  };
  submodels: { [key: string]: string[] } = {
    ...
    'Mahindra Roxor': ['Base', 'Mid', 'Premium'],
    ...
    'Mazda2': ['Sport', 'Touring', 'Grand Touring', 'Skyactiv-G'],
    'Mazda3': ['Sport', 'Touring', 'Carbon Edition', 'Select', 'Preferred', 'Premium', 'Turbo'],
    'Mazda6': ['Sport', 'Touring', 'Grand Touring', 'Signature', 'Carbon Edition'],
