...
export class VehicleDataService {
    ...
    'Acura ILX Base': ['2013','2014','2015','2016','2017','2018','2019','2020','2021','2022'],
    'Acura ILX Premium': ['2013','2014','2015','2016','2017','2018','2019','2020','2021','2022'],
    'Acura ILX Technology': ['2013','2014','2015','2016','2017','2018','2019','2020','2021','2022'],
    'Acura ILX A-Spec': ['2019','2020','2021','2022'],

    'Acura TLX Base': ['2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Acura TLX Technology': ['2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Acura TLX A-Spec': ['2018','2019','2020','2021','2022','2023','2024','2025'],
    'Acura TLX Advance': ['2015','2016','2017','2018','2019','2020','2021','2022'],
    'Acura TLX Type S': ['2021','2022','2023','2024','2025'],

    'Acura RLX Base': ['2014','2015','2016','2017','2018','2019','2020'],
    'Acura RLX Technology': ['2014','2015','2016','2017','2018','2019','2020'],
    'Acura RLX Advance': ['2014','2015','2016','2017','2018','2019','2020'],
    'Acura RLX Sport Hybrid': ['2014','2015','2016','2017','2018','2019','2020'],

    'Acura TSX Base': ['2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014'],
    'Acura TSX Sport': ['2010','2011','2012','2013','2014'],
    'Acura TSX Technology': ['2009','2010','2011','2012','2013','2014'],

    'Acura Integra Base': ['1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2023','2024','2025'],
    'Acura Integra A-Spec': ['2023','2024','2025'],
    'Acura Integra A-Spec Tech': ['2023','2024','2025'],
    'Acura Integra Type S': ['2024','2025'],

    'Acura Legend Base': ['1986','1987','1988','1989','1990','1991','1992','1993','1994','1995'],
    'Acura Legend L': ['1986','1987','1988','1989','1990','1991','1992','1993','1994','1995'],
    'Acura Legend LS': ['1987','1988','1989','1990','1991','1992','1993','1994','1995'],
    'Acura Legend GS': ['1991','1992','1993','1994','1995'],

    'Acura CL Base': ['1997','1998','1999','2000','2001','2002','2003'],
    'Acura CL Type S': ['2001','2002','2003'],

    'Acura EL Base': ['1997','1998','1999','2000','2001','2002','2003','2004','2005'],
    'Acura EL Sport': ['2004','2005'],
    'Acura EL Premium': ['1997','1998','1999','2000','2001','2002','2003','2004','2005'],

    'Acura RL Base': ['1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012'],
    'Acura RL Technology': ['2005','2006','2007','2008','2009','2010','2011','2012'],
    'Acura RL Advance': ['2010','2011','2012'],

    'Acura TL Base': ['1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014'],
    'Acura TL Special Edition': ['2012','2013','2014'],
    'Acura TL Technology': ['2007','2008','2009','2010','2011','2012','2013','2014'],
    'Acura TL SH-AWD': ['2009','2010','2011','2012','2013','2014'],
    'Acura TL Type S': ['2002','2003','2007','2008'],

    'Acura CSX Base': ['2006','2007','2008','2009','2010','2011'],
    'Acura CSX Sport': ['2007','2008','2009','2010','2011'],
    'Acura CSX Premium': ['2006','2007','2008','2009','2010','2011'],

    'Acura RSX Base': ['2002','2003','2004','2005','2006'],
    'Acura RSX Type S': ['2002','2003','2004','2005','2006'],

    'Acura MDX Base': ['2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Acura MDX Technology': ['2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Acura MDX A-Spec': ['2019','2020','2021','2022','2023','2024','2025'],
    'Acura MDX Advance': ['2014','2015','2016','2017','2018','2019','2020','2021','2022'],
    'Acura MDX Type S': ['2022','2023','2024','2025'],

    'Acura RDX Base': ['2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Acura RDX Technology': ['2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Acura RDX A-Spec': ['2019','2020','2021','2022','2023','2024','2025'],
    'Acura RDX Advance': ['2016','2017','2018','2019','2020','2021','2022'],

    'Acura ZDX Base': ['2010','2011','2012','2013','2024','2025'],
    'Acura ZDX A-Spec': ['2024','2025'],
    'Acura ZDX Type S': ['2024','2025'],

    'Acura SLX Base': ['1996','1997','1998','1999'],
    'Acura SLX Premium': ['1996','1997','1998','1999'],

    'Acura Vigor LS': ['1992','1993','1994'],
    'Acura Vigor GS': ['1992','1993','1994'],

    'Acura NSX Base': ['1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2017','2018','2019','2020','2021','2022'],
    'Acura NSX Type S': ['2022'],

    'Alfa Romeo Giulia Base': ['2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Giulia Ti': ['2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Giulia Sprint': ['2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Giulia Veloce': ['2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Giulia Quadrifoglio': ['2016','2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Stelvio Base': ['2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Stelvio Ti': ['2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Stelvio Sprint': ['2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Stelvio Veloce': ['2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Stelvio Quadrifoglio': ['2017','2018','2019','2020','2021','2022','2023','2024','2025'],
    'Alfa Romeo Tonale Sprint': ['2022','2023','2024','2025'],
    'Alfa Romeo Tonale Ti': ['2022','2023','2024','2025'],
    'Alfa Romeo Tonale Veloce': ['2022','2023','2024','2025'],
    'Alfa Romeo 4C Coupe': ['2013','2014','2015','2016','2017','2018'],
    'Alfa Romeo 4C Spider': ['2015','2016','2017','2018','2019','2020'],
    'Alfa Romeo 8C Competizione': ['2007','2008','2009','2010'],
    'Alfa Romeo 8C Spider': ['2008','2009','2010'],
    'Alfa Romeo Spider Base': ['1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005'],
    'Alfa Romeo Spider Veloce': ['1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005'],
    'Alfa Romeo Spider Quadrifoglio Verde': ['1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005'],
    'Alfa Romeo GTV Base': ['1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006'],
    'Alfa Romeo GTV Lusso': ['1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006'],
    'Alfa Romeo GTV Veloce': ['1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006'],
    'Alfa Romeo 166 Base': ['1999','2000','2001','2002','2003','2004','2005','2006','2007'],
    'Alfa Romeo 166 Lusso': ['1999','2000','2001','2002','2003','2004','2005','2006','2007'],
    'Alfa Romeo 166 Super': ['1999','2000','2001','2002','2003','2004','2005','2006','2007'],
    'Alfa Romeo 159 Base': ['2005','2006','2007','2008','2009','2010','2011'],
    'Alfa Romeo 159 Progression': ['2005','2006','2007','2008','2009','2010','2011'],
    'Alfa Romeo 159 Distinctive': ['2005','2006','2007','2008','2009','2010','2011'],
    'Alfa Romeo 159 Ti': ['2005','2006','2007','2008','2009','2010','2011'],
    'Alfa Romeo 147 Base': ['2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010'],
    'Alfa Romeo 147 Distinctive': ['2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010'],
    'Alfa Romeo 147 Ti': ['2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010'],
    'Alfa Romeo 147 GTA': ['2002','2003','2004','2005'],
    'Alfa Romeo 156 Base': ['1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007'],
    'Alfa Romeo 156 Progression': ['1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007'],
    'Alfa Romeo 156 Distinctive': ['1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007'],
    'Alfa Romeo 156 Ti': ['1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007'],
    'Alfa Romeo 156 GTA': ['2002','2003','2004','2005'],
    'Alfa Romeo Brera Base': ['2005','2006','2007','2008','2009','2010'],
    'Alfa Romeo Brera SV': ['2005','2006','2007','2008','2009','2010'],
    'Alfa Romeo Brera S': ['2005','2006','2007','2008','2009','2010'],
    'Alfa Romeo MiTo Base': ['2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018'],
    'Alfa Romeo MiTo Progression': ['2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018'],
    'Alfa Romeo MiTo Distinctive': ['2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018'],
    'Alfa Romeo MiTo Quadrifoglio Verde': ['2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018'],
    'Alfa Romeo Giulietta Base': ['2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020'],
    'Alfa Romeo Giulietta Progression': ['2010','2011','2012','2013','2014','2015'],
    'Alfa Romeo Giulietta Distinctive': ['2010','2011','2012','2013','2014','2015'],
    'Alfa Romeo Giulietta Veloce': ['2016','2017','2018','2019','2020'],
    };
}